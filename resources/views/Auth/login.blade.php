...
@section('content')
    <div
        ...
        <a href="{{ route('dashboard') }}" class="flex gap-4 items-center loginForm hover:bg-white/20 transition duration-300">
        ...
        <div class="flex flex-col gap-6 items-center loginForm">
            <div class="flex flex-col gap-3 items-center">
                ...
                <div class="text-xl text-center">Login untuk membuat resep masakan yang kalian suka.</div>
            </div>
            ...
            <form action="{{ route('authenticate') }}" method="POST" class="w-full flex flex-col gap-6">
                ...
                <button type="submit"
                    class="w-full bg-mainOrange p-5 rounded-3xl mainBorder text-xl hoverOrange">login</button>

            </form>

            <a href="{{ route('register') }}" class="text-xl textHover">Daftar Daichobu?</a>
        </div>
